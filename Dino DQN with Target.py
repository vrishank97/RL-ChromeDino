...
class DQN(nn.Module):
    ...
    def __init__(self, h, w):
        ...
        self.fullconnected1 = nn.Linear(linear_input_size, 16)
...
for i_episode in range(num_episodes):
    ...
    if i_episode % 5000 == 4999:
        torch.save(policy_net.state_dict(), "Models\\Target\\Target%d.pth" % i_episode)

torch.save(policy_net.state_dict(), "Models\\Target\\TargetFinal.pth")
